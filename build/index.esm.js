...
var CaseEnum = propTypes.oneOf(['camel', 'kebab']);
var DropdownEnum = propTypes.oneOf(['display', 'flexDirection', 'justifyContent']);
...
var rsApos$1 = "['\u2019]",
    ...
    rsMisc$1 = '[^' + rsAstralRange$1 + rsBreakRange$1 + rsDigits$1 + rsDingbatRange$1 + rsLowerRange$1 + rsUpperRange$1 + ']',
    rsFitz$1 = '\\ud83c[\\udffb-\\udfff]',
...
/** Used to compose unicode regexes. */
var rsLowerMisc$1 = '(?:' + rsLower$1 + '|' + rsMisc$1 + ')',
    rsUpperMisc$1 = '(?:' + rsUpper$1 + '|' + rsMisc$1 + ')',
    rsOptLowerContr$1 = '(?:' + rsApos$1 + '(?:d|ll|m|re|s|t|ve))?',
    rsOptUpperContr$1 = '(?:' + rsApos$1 + '(?:D|LL|M|RE|S|T|VE))?',
    reOptMod$1 = rsModifier$1 + '?',
    rsOptVar$1 = '[' + rsVarRange$1 + ']?',
    rsOptJoin$1 = '(?:' + rsZWJ$1 + '(?:' + [rsNonAstral$1, rsRegional$1, rsSurrPair$1].join('|') + ')' + rsOptVar$1 + reOptMod$1 + ')*',
    rsSeq$1 = rsOptVar$1 + reOptMod$1 + rsOptJoin$1,
    rsEmoji$1 = '(?:' + [rsDingbat$1, rsRegional$1, rsSurrPair$1].join('|') + ')' + rsSeq$1;
...
var reOptMod$2 = rsModifier$2 + '?',
    ...
    rsSymbol$1 = '(?:' + [rsNonAstral$2 + rsCombo$2 + '?', rsCombo$2, rsRegional$2, rsSurrPair$2, rsAstral$1].join('|') + ')';

/** Used to match [string symbols](https://mathiasbynens.be/notes/javascript-unicode). */
var reUnicode$1 = RegExp(rsFitz$2 + '(?=' + rsFitz$2 + ')|' + rsSymbol$1 + rsSeq$2, 'g');

/** Used to detect strings with [zero-width joiners or code points from the astral planes](http://eev.ee/blog/2015/09/12/dark-corners-of-unicode/). */
var reHasUnicode$1 = RegExp('[' + rsZWJ$2 + rsAstralRange$2  + rsComboMarksRange$2 + rsComboSymbolsRange$2 + rsVarRange$2 + ']');
...
/** Used to compose unicode character classes. */
var rsAstralRange$3 = '\\ud800-\\udfff',
    rsComboMarksRange$3 = '\\u0300-\\u036f\\ufe20-\\ufe23',
    rsComboSymbolsRange$3 = '\\u20d0-\\u20f0',
    rsDingbatRange$2 = '\\u2700-\\u27bf',
...
var rsApos$2 = "['\u2019]",
    ...
    rsCombo$3 = '[' + rsComboMarksRange$3 + rsComboSymbolsRange$3 + ']',
    rsDigits$2 = '\\d+',
    rsDingbat$2 = '[' + rsDingbatRange$2 + ']',
    rsLower$2 = '[' + rsLowerRange$2 + ']',
    rsMisc$2 = '[^' + rsAstralRange$3 + rsBreakRange$2 + rsDigits$2 + rsDingbatRange$2 + rsLowerRange$2 + rsUpperRange$2 + ']',
    rsFitz$3 = '\\ud83c[\\udffb-\\udfff]',
    rsModifier$3 = '(?:' + rsCombo$3 + '|' + rsFitz$3 + ')',
    rsNonAstral$3 = '[^' + rsAstralRange$3 + ']',
    rsRegional$3 = '(?:\\ud83c[\\udde6-\\uddff]){2}',
    rsSurrPair$3 = '[\\ud800-\\udbff][\\udc00-\\udfff]',
...
var rsLowerMisc$2 = '(?:' + rsLower$2 + '|' + rsMisc$2 + ')',
    ...
    rsOptVar$3 = '[' + rsVarRange$3 + ']?',
    rsOptJoin$3 = '(?:' + rsZWJ$3 + '(?:' + [rsNonAstral$3, rsRegional$3, rsSurrPair$3].join('|') + ')' + rsOptVar$3 + reOptMod$3 + ')*',
    rsSeq$3 = rsOptVar$3 + reOptMod$3 + rsOptJoin$3,
    rsEmoji$2 = '(?:' + [rsDingbat$2, rsRegional$3, rsSurrPair$3].join('|') + ')' + rsSeq$3;
...
function convertProperty(attr) {
  return lodash_words(attr).map(lodash_upperfirst).join(' ');
}
function propertyCasing(property, casing) {
  switch (casing) {
    case 'camel':
      return lodash_camelcase(property);

    case 'kebab':
      return lodash_kebabcase(property);
...
function transformSizeInput(str) {
  var _splitSizeStr = splitSizeStr(str),
      _splitSizeStr2 = _slicedToArray(_splitSizeStr, 2),
      value = _splitSizeStr2[0],
      unit = _splitSizeStr2[1];
...
function devError() {
  if (process.env.NODE_ENV !== 'production') {
    ...
    (_console = console).error.apply(_console, ['CSS Editor:'].concat(args));
  }
}
function devLog() {
  if (process.env.NODE_ENV !== 'production') {
    ...
    (_console2 = console).warn.apply(_console2, ['CSS Editor:'].concat(args));
  }
}

function styleReducer(state, _ref) {
...
function Editor(_ref2) {
  var _ref2$casing = _ref2.casing,
      casing = _ref2$casing === void 0 ? 'camel' : _ref2$casing,
      children = _ref2.children,
      _ref2$onChange = _ref2.onChange,
      onChange = _ref2$onChange === void 0 ? function () {} : _ref2$onChange,
      _ref2$style = _ref2.style,
      initialStyle = _ref2$style === void 0 ? {} : _ref2$style;

  var _React$useReducer = React.useReducer(styleReducer, initialStyle),
      _React$useReducer2 = _slicedToArray(_React$useReducer, 2),
      style = _React$useReducer2[0],
      dispatchStyle = _React$useReducer2[1];
...
function useProperty(property) {
  var _React$useContext = React.useContext(EditorContext),
      ...
      dispatchStyle = _React$useContext.dispatchStyle;
...
function SizeInput(_ref) {
  ...
  var _transformSizeInput = transformSizeInput(propertyValue),
      _transformSizeInput2 = _slicedToArray(_transformSizeInput, 2),
      sizeValue = _transformSizeInput2[0],
      sizeUnit = _transformSizeInput2[1];

  function updateSizeValue(_ref2) {
...
export { ColorPicker, Dropdown, Option, SizeInput, Slider, useProperty };
